        ...
        starlightSidebarTopics([
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'Act 1 · The Primitives', items: [{ autogenerate: { directory: 'workshops/zero-to-kiro-hero/01-primitives' } }] },
              { label: 'Act 2 · Working in Unfamiliar Code', items: [{ autogenerate: { directory: 'workshops/zero-to-kiro-hero/02-unfamiliar-code' } }] },
              { label: 'Act 3 · Deploy & Troubleshoot', items: [{ autogenerate: { directory: 'workshops/zero-to-kiro-hero/03-deploy-troubleshoot' } }] },
